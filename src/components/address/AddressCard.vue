<template>
  <div class="address-wrapper d-flex h-100">
    <AddressModal :isSingleCoin="true"
                  :coinsOptions="[name]">
    </AddressModal>
          ...
          <div class="address-card__coin-info">
            <div class="coin-container mb-2 mb-md-0 mr-md-4">
              <img
                ...
                alt="Coin"
                class="coin-icon"
                :class="{'coin-icon--remme': coinIcon.includes('remme'),
                         'coin-icon--daobet': coinIcon.includes('daobet')}"
              >
            </div>
